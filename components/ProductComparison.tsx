    ...
    <section className="section-padding bg-gray-50">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-6">Product Comparison Tool</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Compare specifications, applications, and features across our product portfolio to find the perfect solution
            for your needs.
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="flex flex-wrap gap-4 mb-6">
            {selectedProducts.map((product) => (
              <div key={product.id} className="flex items-center bg-[var(--primary)] text-white px-4 py-2 rounded-lg">
                <span className="mr-2">{product.name}</span>
                <button
                  onClick={() => removeProduct(product.id)}
                  className="hover:bg-white hover:text-[var(--primary)] rounded-full p-1 transition-colors"
                >
                  <X size={16} />
                </button>
              </div>
            ...
            {selectedProducts.length < 4 && (
              <button
                ...
                className="flex items-center border-2 border-dashed border-gray-300 text-gray-600 px-4 py-2 rounded-lg hover:border-[var(--primary)] hover:text-[var(--primary)] transition-colors"
              >
          ...
          {showProductSelector && (
            <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                {availableProducts
                  ...
                  .map((product) => (
                    ...
                    >
                      ...
                      />
                      <h4 className="font-semibold text-[var(--primary)] mb-1">{product.name}</h4>
              ...
              <button
                ...
                className="mt-4 text-gray-600 hover:text-[var(--primary)]"
              >
                Cancel
              </button>
            </div>
